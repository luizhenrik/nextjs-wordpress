  ...
  return (
        <div className={`${style['home-services']}`}>
            <div className={`${style['home-services__content']}`}>
                <h2 className={`${style['home-services__title']}`}>Lorem Ipsum</h2>
                ...
                <div className={`${style['home-services__container']}`}>
                    <div className={`${style['home-services__item']}`}>
                        <h4 className={`${style['home-services__item-title']}`}>Lorem #1</h4>
                    ...
                    <div className={`${style['home-services__item']}`}>
                        <h4 className={`${style['home-services__item-title']}`}>Lorem #2</h4>
                    ...
                    <div className={`${style['home-services__item']}`}>
                        <h4 className={`${style['home-services__item-title']}`}>Lorem #3</h4>
